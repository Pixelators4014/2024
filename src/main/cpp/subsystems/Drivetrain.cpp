...
Drivetrain::Drivetrain()
{
  ...
  AutoBuilder::configureHolonomic(
      ...
      [this]()
      { return GetSpeeds(); }, // ChassisSpeeds supplier. MUST BE ROBOT RELATIVE
...
{
  auto states =
      m_kinematics.ToSwerveModuleStates(frc::ChassisSpeeds::Discretize(robotRelativeSpeeds, 0.02_s));
