...
Arm::Arm()
    ...
    left_motor_FX_config.CurrentLimits.SupplyCurrentLimitEnable = kArmCurrentLimitEnable;
    right_motor_FX_config.CurrentLimits.SupplyCurrentLimitEnable = kArmCurrentLimitEnable;
    ...
    left_motor_FX_config.CurrentLimits.SupplyCurrentThreshold = kArmCurrentThreshold;
    right_motor_FX_config.CurrentLimits.SupplyCurrentThreshold = kArmCurrentThreshold;
    ...
    left_motor_FX_config.OpenLoopRamps.DutyCycleOpenLoopRampPeriod = kArmDutyCycleOpenLoopRampPeriod;
    right_motor_FX_config.OpenLoopRamps.DutyCycleOpenLoopRampPeriod = kArmDutyCycleOpenLoopRampPeriod;

    left_motor_FX_config.OpenLoopRamps.VoltageOpenLoopRampPeriod = kArmVoltageOpenLoopRampPeriod;
    right_motor_FX_config.OpenLoopRamps.VoltageOpenLoopRampPeriod = kArmVoltageOpenLoopRampPeriod;

    left_motor_FX_config.ClosedLoopRamps.DutyCycleClosedLoopRampPeriod = kArmDutyCycleClosedLoopRampPeriod;
    right_motor_FX_config.ClosedLoopRamps.DutyCycleClosedLoopRampPeriod = kArmDutyCycleClosedLoopRampPeriod;

    left_motor_FX_config.ClosedLoopRamps.VoltageClosedLoopRampPeriod = kArmVoltageClosedLoopRampPeriod;
    right_motor_FX_config.ClosedLoopRamps.VoltageClosedLoopRampPeriod = kArmVoltageClosedLoopRampPeriod;
